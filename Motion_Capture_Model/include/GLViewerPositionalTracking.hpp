...
//// UTILS //////
using namespace std;
void printPositionalTracking(std::string msg_prefix, sl::ERROR_CODE err_code = sl::ERROR_CODE::SUCCESS, std::string msg_suffix = "") ;

/////////////////
class CameraGLPositionalTracking {
public:

    CameraGLPositionalTracking();
    ~CameraGLPositionalTracking();
...
class ShaderPositionalTracking {
public:

    ShaderPositionalTracking() : verterxId_(0), fragmentId_(0), programId_(0) {}
    ShaderPositionalTracking(const GLchar* vs, const GLchar* fs);
    ~ShaderPositionalTracking();

    // Delete the move constructor and move assignment operator
    ShaderPositionalTracking(ShaderPositionalTracking&&) = delete;
    ShaderPositionalTracking& operator=(ShaderPositionalTracking&&) = delete;

    // Delete the copy constructor and copy assignment operator
    ShaderPositionalTracking(const ShaderPositionalTracking&) = delete;
    ShaderPositionalTracking& operator=(const ShaderPositionalTracking&) = delete;
...
class Simple3DObjectPositionalTracking {
public:

    Simple3DObjectPositionalTracking();
    Simple3DObjectPositionalTracking(sl::Translation position, bool isStatic);
    ~Simple3DObjectPositionalTracking();
...
struct ShaderDataPositionalTracking {
    ShaderPositionalTracking it;
    GLuint MVP_Mat;
};

// This class manages input events, window and Opengl rendering pipeline
class GLViewerPositionalTracking {
public:
    GLViewerPositionalTracking();
    ~GLViewerPositionalTracking();
    void exit();
    bool isAvailable();
...
private:
    ...
    Simple3DObjectPositionalTracking floor_grid;
    Simple3DObjectPositionalTracking zedModel;
    Simple3DObjectPositionalTracking zedPath;
    ...
    CameraGLPositionalTracking camera_;
    ShaderDataPositionalTracking shaderLine;
    ShaderDataPositionalTracking mainShader;
};
